...
export function Footer() {
  return (
    <footer className="bg-primary border-t border-border mt-auto">
      ...
      <div className="bg-black w-full py-8 mt-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-white/80">
            <div className="flex items-center gap-4">
              <span className="font-semibold uppercase tracking-wider text-xs">Follow Us:</span>
              <div className="flex gap-4">
                <a href="https://www.instagram.com/grannydiets?igsh=cTc0dnBmbDN6eGRj" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
                ...
                <a href="https://www.facebook.com/share/1FmnowGaPX/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Facebook">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="https://x.com/MohdMudass15851" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="X (Twitter)">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 text-center sm:text-left">
              ...
              <div className="flex flex-wrap justify-center items-center gap-3 bg-white/10 px-3 py-2 rounded-md">
                ...
                <Image src="/images/razorpay.png" alt="Razorpay" width={60} height={25} className="h-5 w-auto object-contain rounded-sm"/>
              </div>
            </div>
          </div>

          <div className="border-t border-white/20 mt-8 pt-6 pb-2 text-center text-sm text-white/50">
